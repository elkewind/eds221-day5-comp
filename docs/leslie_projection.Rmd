...
# The line below creates a time sequence vector
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below creates an empty matrix
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below fills the first row with 
proj_year[1, ] <- fish_year0

# The for loop below populates proj_year matrix with the dot product of fish_leslie and the previous years population
